describe("Example", () => {
  ...
  it("The output should move like  toggle", () => {
    ...
    var e = jQuery.Event("mousemove", { pageX: barLeft + expectedMovePx });
    toggle.trigger(e);
    let endPosToggle = toggle.css("left");
    let endOutputPos = output.css("marginLeft");
    expect(endOutputPos).toEqual(endPosToggle);
  });
  ...
  it("The toggle2 should have a limitation on the right", () => {
    ...
    // let barLeft = bar.offset().left;
    let barWidth = bar.outerWidth();
    let toggleWidth = toggle2.outerWidth();
    toggle2.trigger("mousedown");
    var e = jQuery.Event("mousemove", { pageX: expectedMovePx });
    toggle2.trigger(e);
    let endPos = toggle2.css("left");
  ...
  it("The toggleY should have a limitation on the bottom", () => {
    $("#slider1").Slider({ vertical: true });
    let expectedMovePx = 900;
    let toggle = $(".slider__toggle");
    let bar = $(".slider__barY");
  ...
  it("The toggle2 should move verticaly", () => {
    $("#slider1").Slider({ vertical: true });
    let expectedMovePx = 64;
    let toggle2Y = $("#slider1 .slider__toggle2Y");
    let bar = $("#slider1 .slider__barY");
    let barTop = bar.offset().top;
    toggle2Y.trigger("mousedown");
    var e = jQuery.Event("mousemove", { pageY: barTop + expectedMovePx });
    toggle2Y.trigger(e);
    let endPos = toggle2Y.css("top");
    expect(endPos).toEqual(64 + "px");
  });
  it("The toggle2Y should have a limitation on the top", () => {
    $("#slider1").Slider({ vertical: true });
    let toggle2 = $(".slider__toggle2Y");
    toggle2.trigger("mousedown");
    var e = jQuery.Event("mousemove", { pageY: 20 });
    toggle2.trigger(e);
  ...
  it("toggle2Y should have a limitation on the bottom", () => {
    $("#slider1").Slider({ vertical: true });
    let expectedMovePx = 900;
    let toggle = $(".slider__toggle");
